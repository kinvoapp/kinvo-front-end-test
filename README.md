...
Having Yarn installed in your developer ambient.

```shell
run 'yarn':
  to install all libs that are necessarie

run 'yarn dev':
  to get up the project, it will be on port https://localhost:3000
```
