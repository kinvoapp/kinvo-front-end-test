...
class PlansArea extends Component {
	...
	state = {
		plans: [
			...
			{ id: 1, planType: 'Plano Mensal', baseColor: '#0DD1E3', description: ['5 carteiras', 'Produtos ilimitados', 'Produtos sem limite de início', 'Análises Avançadas', 'Acesso a versão web'], price: 'R$14,90 por mês' },
			{ id: 2, planType: 'Plano Anual', baseColor: '#9E51BA', description: ['5 carteiras', 'Produtos ilimitados', 'Produtos sem limite de início', 'Análises Avançadas', 'Acesso a versão web'], price: 'R$99,90 por ano' },
		]
	}
