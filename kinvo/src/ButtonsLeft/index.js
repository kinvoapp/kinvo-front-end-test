    ...
    render(){
        return (
            <Line width = {1366}>
                ...
                <LeftSide>
                {/* ÍNICIO ESTILIZAÇÃO + FUNCIONAMENTO DOS BOTÕES DA LATERAL ESQUERDA */}
                ...
                {/* BOTÃO QUE LIBERA PÁGINA QUE CONTÉM A LISTA QUANDO SELECIONADO*/}
                ...
                {/* FIM DO BOTÃO QUE LIBERA PÁGINA QUE CONTÉM A LISTA */}
            ...
            {/* FINAL DOS BOTÕES DA LATERAL ESQUERDA */}

            {/* PÁGINA QUE CONTÉM A LISTA PARA FILTRAGEM */}
                <div id="Teste"><PageList/></div>
            </Line>
        )
    }
}
