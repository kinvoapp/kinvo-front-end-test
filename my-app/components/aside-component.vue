<template>
  <div class="flex h-screen flex-col justify-between border-r bg-white">
    <div class="grid grid-cols-6 px-4 py-6">
      <nav aria-label="Main Nav" class="mt-6 col-span-1 flex flex-col space-y-1">
        <a
          href="#"
    ...
    <div class="sticky inset-x-0 bottom-0 border-t border-gray-100">
      <a href="#" class="flex items-center gap-2 bg-white p-4 hover:bg-gray-50">
        ...
        <div>
          <p class="text-xs">
            <strong class="block font-medium">Gabriel Aquino</strong>
            <span> gabriel.aquino@outlook.com </span>
          </p>
        </div>
      </a>
    </div>
