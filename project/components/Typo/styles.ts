...
export const StyledText = styled.p<StyledTextProps>`
  font-size: ${p => p.fontSize ?? textStyles[p.variant ?? "normal"]?.fontSize}px;
  color: ${p => p.color ?? textStyles[p.variant ?? "normal"]?.color};
  font-weight: ${p => p.fontWeight ?? textStyles[p.variant ?? "normal"]?.fontWeight};
...
export const StyledTitle = styled.h1<StyledTitleProps>`
  ...
  font-weight: ${p => p.fontWeight ?? titleStyles[p.variant ?? "h1"]?.fontWeight};
  margin: 10px 0;
`;