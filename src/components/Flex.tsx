    ...
    return (
        <div
            style={{
                ...
                paddingRight: spacing(paddingRight ?? paddingX ?? padding ?? 0),
                paddingBottom: spacing(paddingBottom ?? paddingY ?? padding ?? 0),
...
function number(value?: string|number|boolean): number|undefined {
    switch (typeof value) {
        case "number":
            return value;
        case "string":
