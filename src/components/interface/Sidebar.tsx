...
const SidebarWrapper = styled.aside`
  ...
  background: linear-gradient(to bottom, ${(props) =>
    getTheme(props).background.lighter}, ${(props) =>
  getTheme(props).background.lightest} 4rem)
`;
...
const SidebarItemWrapper = styled.div.attrs((props) => ({
  ...
  align-items: center;
  gap: 1rem;
  border-bottom: ${(props) => getTheme(props).background.main} solid
    2px;
  background-color: ${(props) =>
    props.hover || props.active
      ? getTheme(props).background.light
      : "transparent"};
