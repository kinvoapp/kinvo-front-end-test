...
const FixedIncomeContext: Context<FixedIncomeAPIResponse | null> =
  createContext(null as FixedIncomeAPIResponse | null);
const FixedIncomeProvider = FixedIncomeContext.Provider;

export { FixedIncomeContext, FixedIncomeProvider };
