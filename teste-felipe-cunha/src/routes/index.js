...
export default function Routes() {
  return (
    <Switch>
      ...
      <Route exact path="/acao" component={Outras} />
      <Route exact path="/fundo" component={Outras} />
      <Route exact path="/fundoi" component={Outras} />
      ...
      <Route exact path="/saldo" component={Outras} />
      <Route exact path="/valor" component={Outras} />
      <Route exact path="/rentabilidade" component={Outras} />
    </Switch>
  );
}
